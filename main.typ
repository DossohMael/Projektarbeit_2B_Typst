...
Das vorliegende Kapitel dient der Erläuterung von Konzepten und Begriffen, die für das Verständnis dieser Arbeit erforderlich sind. Der Schwerpunkt liegt dabei auf dem #acrs("QM"), dem daraus entspringenden #acrs("QMS"), #acrs("SW")-Qualitätsanforderungen sowie den spezifischen Anforderungen und Herausforderungen von #acrs("KMU"). Die vorliegende Untersuchung orientiert sich in erster Linie an die Normen "#acrs("ISO") 9000" @iso9000a[Fundamentals and vocabulary], "#acrs("ISO") 9001" @iso9001b[Requirements] sowie "#acrs("ISO") 25000" @iso25000.
...
#set quote(block: true)
#quote(["Der Grad, in dem ein Satz inhärenter Merkmale Anforderungen erfüllt."  @iso9000a[Fundamentals and vocabulary]]) 

Unter „Inhärenten Merkmalen“ werden diejenigen Merkmale eines Produkts, einer Dienstleistung oder eines Prozesses verstanden, die diesem innewohnen @iso9000a[Fundamentals and vocabulary]. Demgegenüber stehen die „Anforderungen“, welche Bedürfnisse oder Erwartungen widerspiegeln, die in der Regel festgelegt, vorausgesetzt oder verpflichtend sind. Die vorliegende Definition verdeutlicht, dass der Begriff der Qualität nicht als absolut, sondern als relativ zu den jeweils spezifischen Anforderungen zu betrachten ist. In diesem Kontext können die Anforderungen sowohl die Bedürfnisse und Erwartungen der Kundinnen und Kunden als auch gesetzliche und regulatorische Vorgaben sowie weitere, festgelegte Anforderungen umfassen. Die Erfüllung dieser Anforderungen ist von entscheidender Bedeutung für die Zufriedenheit der Kundinnen und Kunden sowie für den Erfolg eines Unternehmens. @iso9000a[Fundamentals and vocabulary]
...
#set quote(block: true)
#quote(["Koordinierte Tätigkeiten zum Leiten und Steuern einer Organisation." @iso9000a[Fundamentals and vocabulary]])
Die angeführte Definition verdeutlicht, dass Management die Aktivitäten umfasst, die notwendig sind, um die Ziele einer Organisation zu erreichen. Dies umfasst die Planung, Leitung und Koordination sämtlicher Aktivitäten und Ressourcen. Diese Definition ist wesentlich für das Verständnis von #acrs("QM"), da sie die Notwendigkeit einer systematischen und methodischen Herangehensweise betont, die notwendig ist, um eine Organisation effektiv und effizient zu führen und zu steuern. @iso9000a[Fundamentals and vocabulary]

Die zuvor dargelegten Definitionen bilden in ihrer Kombination die Grundlage für #acrs("QM"). Dieses befasst sich mit der Sicherstellung, dass sämtliche Tätigkeiten innerhalb einer Organisation so geplant und durchgeführt werden, dass sie die festgelegten Anforderungen erfüllen @iso9000a[Fundamentals and vocabulary]. Ein effektives #acrs("QM") bedingt eine fortwährende Überwachung und Evaluierung der Prozesse und Produkte, um die Einhaltung der definierten Standards sicherzustellen. Dies umfasst regelmäßige Audits sowie Schulungen der Mitarbeitenden, um sicherzustellen, dass alle Organisationsebenen die Qualitätsziele verstehen und darauf hinarbeiten @iso9001b[Requirements].
...
#pagebreak()
Gemäß gemäß #acrs("ISO") bilden die in @fig-7qmprinciples dargestellten Konzepte  9000 das Fundament des #acrs("QM") @iso9000a[Fundamentals and vocabulary]:
...
Ein #acrs("QMS"), wie es in der #acrs("ISO") 9001 definiert ist, stellt ein formales System dar, welches die Organisationsstruktur, Prozesse und Ressourcen umfasst. Die Umsetzung der genannten Kriterien ist erforderlich, um die Qualitätsziele zu erreichen. @iso9001b[Requirements] 
...
== Der Prozessansatz
@iso9000a[Fundamentals and vocabulary]
