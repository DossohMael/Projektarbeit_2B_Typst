...
#figure(caption: [Plan-Do-Check-Act Cycle für Qualitätsmanageme @iso9001], image(width: 13cm, "figures/ISO9001PDCA.png"))<fig-pdcaiso9001>
...
Die dritte Phase, "Check", wird durch Klausel neun, "Performance evaluation", definiert. Diese umfasst die Bewertung der Leistung, welche die Überwachung, Messung, Analyse und Bewertung des #acrs("QMS")-Leistung beinhaltet. Dies beinhaltet ebenfalls interne Audits und Managementbewertungen. @iso9001
