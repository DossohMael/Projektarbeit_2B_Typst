...
#acrs("QMS") gemäß #acrs("ISO") 9001 verwenden eine dem #acrs("QM") angepasste form des #acrs("PDCA"). Die #acrs("ISO") 9001 umfasst zehn Klauseln, wobei die ersten drei den Anwendungsbereich, normative Verweisungen und Begriffsbestimmungen behandeln. Die folgenden sieben Klauseln umfassen spezifische Anforderungen an das #acrs("QMS"). Diese Anforderungen betreffen den Kontext der Organisation, die Führung, die Planung, die Unterstützung, den Betrieb, die Bewertung der Leistung und die Verwirklichung von Verbesserungen @iso9001de.
@fig-pdcaiso9001 zeigt, sind ie Klauseln 4 bis 10 der #acrs("ISO") 9001 legen die Anforderungen an ein #acrs("QMS"): 
...
Die erste Phase des PDCA-Zyklus, das Planen, umfasst die Klauseln vier bis sechs der ISO 9001. Die vierte Klausel thematisiert den Kontext der Organisation. Dieser muss von der Organisation verstanden werden, wobei sowohl interne als auch externe Faktoren zu berücksichtigen sind. Diese können die Ziele der Organisation sowie deren Fähigkeit, die gewünschten Ergebnisse des Qualitätsmanagementsystems zu erreichen, beeinflussen.Die fünfte Klausel thematisiert die Verantwortung der Führungskräfte. Diese sind dazu verpflichtet, die Qualitätspolitik zu definieren und sicherzustellen, dass diese mit den strategischen Zielen der Organisation übereinstimmt. Die Führungskräfte geben die Vision und Richtung vor, weshalb die fünfte Klausel von zentraler Bedeutung ist und im Zentrum des gesamten Systems steht. Die sechste Klausel umfasst die Festlegung von Maßnahmen zur Bewältigung von Risiken und Nutzung von Chancen sowie die Definition von Qualitätszielen und die Planung von Änderungen. In der Planungsphase erfolgt zunächst die Definition von Maßnahmen zur Bewältigung von Risiken sowie zur Nutzung von Chancen. @iso9001de
