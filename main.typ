...
Die dritte Phase, "Check", wird durch Klausel neun, "Performance evaluation", definiert. Diese umfasst die Bewertung der Leistung, welche die Überwachung, Messung, Analyse und Bewertung des #acrs("QMS")-Leistung beinhaltet. Dies beinhaltet ebenfalls interne Audits und Managementbewertungen. @iso9001de
